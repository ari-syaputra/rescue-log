    ...
    <div class="p-4 flex-1 overflow-y-auto">
        <nav class="space-y-1.5">
            ...
            @elseif(in_array($role, ['komando', 'koordinator_komando', 'posko_komando']))
                ...
                <a href="{{ route('komando.sos.index') }}"
                    class="flex items-center gap-3.5 px-3.5 py-3 rounded-xl font-semibold text-sm transition-all duration-200 {{ request()->routeIs('komando.sos.*') ? 'bg-rose-600 text-white shadow-lg shadow-rose-600/30' : 'text-indigo-200/70 hover:bg-white/10 hover:text-white' }}">
                    <x-fas-truck-medical class="w-5 h-5 shrink-0 text-rose-400 group-hover:text-white" />
