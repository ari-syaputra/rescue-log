    ...
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden border border-slate-100 transform transition-all">
        ...
        <form id="formValidasi" action="" method="POST" enctype="multipart/form-data" class="p-6 space-y-4">
            ...
            <div>
                ...
                <input type="number" name="estimasi_pengungsi_awal" min="1" required placeholder="Contoh: 500"
                ...
                <p class="text-[10px] text-slate-500 mt-1">Digunakan sebagai variabel acuan kuota logistik awal.</p>
            </div>
            ...
            <div>
                ...
                <input type="file" name="sk_status_darurat" accept=".pdf,.jpg,.jpeg,.png" required
            ...
            <div class="bg-amber-50/70 border border-amber-200/60 p-3 rounded-xl flex items-start gap-2.5">
                ...
                <p class="text-[11px] text-amber-900 leading-relaxed">
                    Setelah menekan <strong>Lanjut Setup Posko</strong>, data bencana akan divalidasi dan Anda akan diarahkan untuk mengisi detail lokasi operasional Posko Komando Utama.
                </p>
            </div>
